                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        child: MaterialButton(
                                                                          onPressed:
                                                                            ...
                                                                            String
                                                                                nameFriend =
                                                                                (UserModel.fromMap(await FirebaseFirestore.instance.collection('users').doc(PassMarker.uidFriend[index]).get())).firstName!;
                                                                            Navigator.push(context,
                                                                                MaterialPageRoute(builder: (context) => ChatDetail(friendName: nameFriend, friendUid: PassMarker.uidFriend[index], hp: false)));
                                                                          },
                                                                          child: Text(
                                                                              'Chat',
                                                                              textAlign: TextAlign.center,
